...
return t.Album({
	...
	song("O Plebeu", "The Plebeian", {
		...
		t.br(),
		t.Lyric("01:12", "The last shall be first", "O último será o primeiro"),
		t.Lyric("01:15", "And I'm the last", "E o último sou eu"),
		...
		t.br(),
		t.Lyric("02:01", "The last shall be first", "O último será o primeiro"),
		t.Lyric("02:04", "And I'm the last", "E o último sou eu"),
